...
#define APP_COMMISSIONING_END_DEVICE_REJOIN_MAX_DELAY ((uint32)2700000) // 30 minutes 30 * 60 * 1000
#define APP_COMMISSIONING_END_DEVICE_REJOIN_START_DELAY 30 * 1000 // 3 seconds
#define APP_COMMISSIONING_END_DEVICE_REJOIN_BACKOFF ((float) 1.2)
#define APP_COMMISSIONING_END_DEVICE_REJOIN_TRIES 5
